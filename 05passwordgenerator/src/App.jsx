...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(()=>{
    ...
    passwordRef.current?.setSelectionRange(0, 100);  //slects only 100 values
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-1 my-8 bg-gray-700 text-orange-500">
